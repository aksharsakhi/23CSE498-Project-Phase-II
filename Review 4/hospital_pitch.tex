...
% --- NEW SLIDE 3: SEPSIS STATS IN INDIA ---
    ...
    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            \begin{block}{National Mortality \& Case Load}
                ...
                \end{itemize}
                \vspace{0.1cm}
                Source: \href{https://www.georgeinstitute.org.in/projects/sepsis-in-india-prevalence-study-sips}{\textcolor{clinicTeal}{\underline{The George Institute for Global Health, 2020}}}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.5\textwidth}
            \begin{block}{Indian ICU Mortality Metrics}
                ...
                \end{itemize}
                \vspace{0.1cm}
                Source: \href{https://pubmed.ncbi.nlm.nih.gov/30704986/}{\textcolor{clinicTeal}{\underline{Indian Society of Critical Care Medicine (ISCCM)}}}
            \end{block}
        \end{column}
    \end{columns}
    
    \begin{alertblock}{Clinical Takeaway for Hospital Management}
        \scriptsize
        Given that severe sepsis mortality in Indian ICUs exceeds 34\%, implementing a localized, real-time early warning system is the most cost-effective and clinically viable strategy to save lives.
    \end{alertblock}
\end{frame}
