...
\begin{frame}{Clinical Profile of ICU Sepsis}
    ...
    \begin{alertblock}{Role of Our Project}
        \scriptsize
        By continuously analyzing ICU vital signals, our FPDAF framework acts as an early-warning radar system, alerting doctors hours before a patient clinically deteriorates, giving clinicians a vital head-start to administer antibiotics and fluids.
    \end{alertblock}
\end{frame}
