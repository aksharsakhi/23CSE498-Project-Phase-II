...
\begin{frame}{Project Roadmap \& Future Work}
    ...
    \begin{table}
        ...
        \begin{tabular}{|l|l|c|}
            ...
            \hline
            \textbf{Future (Review 4)} & \textbf{Next Step:} Invent \textit{Dynamic Dual-Phase (DDP)} Cross-Attention Algorithm & \textbf{\textcolor{blue}{Pending}} \\
            \hline
            \textbf{Future (Review 4)} & \textbf{Next Step:} Implement \textit{Entropy-Regularized Personalization (ERP)} & \textbf{\textcolor{blue}{Pending}} \\
            \hline
            \textbf{Future (Review 4)} & \textbf{Next Step:} Final 6-Way Benchmarking (aiming for $>95\%$ Accuracy) & \textbf{\textcolor{blue}{Pending}} \\
            \hline
        \end{tabular}}
    \end{table}
    \vspace{0.2cm}
