...
\begin{frame}{Project Roadmap \& Future Work}
    \scriptsize
    \begin{table}
        \centering
        ...
        \begin{tabular}{|l|l|c|}
            ...
            \hline
            \textbf{Future Work} & \textbf{Next Step:} Invent \textit{Dynamic Dual-Phase (DDP)} Cross-Attention Algorithm & \textbf{\textcolor{blue}{Pending}} \\
            \hline
    ...
    \begin{block}{Roadmap Alignment}
        100\% of Review 3 objectives have been completed. Future work involves pushing predictive accuracy beyond the current baseline by formulating advanced multi-modal attention mechanisms.
    \end{block}
\end{frame}
