...
% --- CLINICIAN DASHBOARD: DRIFT MONITOR ---
\begin{frame}{Clinician Dashboard Interface (Drift Monitor)}
    \begin{figure}
        \centering
...
\begin{frame}{Project Roadmap \& Future Work (60\% Project Objectives Met)}
    ...
    \begin{table}
        ...
        \begin{tabular}{|l|l|c|}
            ...
            \hline
            \textbf{Phase II (Review 3)} & \textbf{Next Step:} Invent \textit{Dynamic Dual-Phase (DDP)} Cross-Attention Algorithm & \textbf{\textcolor{green!60!black}{Completed}} \\
            \hline
