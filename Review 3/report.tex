...
To handle temporal drift without constant full-parameter aggregation, our novel \textbf{Adaptive Divergence-Weighted CUSUM (AD-CUSUM)} monitors multi-modal validation error progression at communication round $r$:
