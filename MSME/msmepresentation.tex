...
% Branding Colors (Premium Light Workstation Palette)
\definecolor{darkSlate}{HTML}{F8FAFC}    % Clean Light Slate Canvas (slate-50)
\definecolor{cardBg}{HTML}{FFFFFF}       % Pure White Card Background
\definecolor{neonCyan}{HTML}{0891B2}     % Deep Cyan (Primary Accent)
\definecolor{neonTeal}{HTML}{0F766E}     % Deep Teal (Secondary Accent)
\definecolor{neonAmber}{HTML}{D97706}    % Deep Amber (Warning Accent)
\definecolor{neonRose}{HTML}{E11D48}     % Deep Rose (Critical Indicator)
\definecolor{textColor}{HTML}{1E293B}    % Dark Slate Body Text (slate-800)
\definecolor{mutedText}{HTML}{64748B}    % Muted Slate Text (slate-500)

% Block Header Tints (Aesthetics)
\definecolor{lightCyanBg}{HTML}{ECFEFF}
\definecolor{lightAmberBg}{HTML}{FEF3C7}
\definecolor{lightTealBg}{HTML}{F0FDFA}
\definecolor{lightRoseBg}{HTML}{FFE4E6}
...
\begin{frame}[plain]
    ...
    \centering
    \vspace{0.6cm}
    \includegraphics[width=1.6cm]{images/logosquare.png} 
    \vspace{0.3cm}

    {\Large \textbf{\textcolor{neonCyan}{FPDAF: CLINICAL AI EARLY-WARNING WORKSTATION}}} \\
    \vspace{0.1cm}
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{TRL 4/5 Readiness Status}}
                ...
                \begin{itemize}
                    \item \textbf{Validated Backend:} Validated on a simulated hospital network of 40,000+ ICU patient records.
                    \item \textbf{Operational Workstations:} Bedside clinician dashboard and administrative telemetry dashboard are fully operational.
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonTeal}{Clinical Pilot Validation}}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Clinical Mentorship:} Pilot testing is advised and overseen by senior ICU clinicians and mentors.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{[Growth]} TAM/SAM/SOM Sizing}
                ...
                \begin{itemize}
                    \item \textbf{TAM: \$120M} (India's Clinical Decision Support System market)$^\dagger$.
                    \item \textbf{SAM: \$45M} (Corporate/private hospital ICU networks representing ~40,000 corporate beds).
                    \item \textbf{SOM: \$5M} (Regional hospital networks targetable in Years 1--2 representing 12 chains).
                \end{itemize}
            \end{block}
        \end{column}
    ...
    \begin{columns}[t]
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonCyan}{\textbf{1. Technology \& Ops}}}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item Procurement of 3 Edge-AI Bedside Nodes (3.5L).
                    \item Local clinical data curation and annotation (3.5L).
                    \item Penetration testing \& DPDPA security audits (3.0L).
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonTeal}{\textbf{2. Clinical Mentorship}}}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item Honorarium for expert ICU clinical advisors.
                    \item Diagnostic validation consultants.
                    \item Institutional incubation \& host facility support.
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonAmber}{\textbf{3. Field Travel \& Trials}}}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item On-site clinical node installations.
                    \item Multi-site telemetry debugging.
                    \item Travel for clinical audits across ICU networks.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}{Why FPDAF is the Perfect Fit for MSME Funding}
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
