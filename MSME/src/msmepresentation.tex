...
\begin{frame}[plain]
    ...
    \begin{minipage}{0.85\textwidth}
        \begin{block}{}
            ...
            \vspace{0.1cm}
            \scriptsize
            \textcolor{neonAmber}{\textbf{MSME Idea Hackathon 6.0 Proposal}} \quad | \quad \textcolor{neonCyan}{\textbf{Sub-Theme 6: Frontier Technologies}}\\
            \vspace{0.15cm}
            \textcolor{textColor}{\textbf{Student Innovators:} Sheela Akshar Sakhi, Hasini Reddy M, Kousik Sarma Lakkaraju, Haswitha K, V. Chakravarthy}\\
            \textcolor{mutedText}{\textbf{Mentors:} Dr. Ramya G. R. (Lead Mentor) \& Dr. Vandhana S. (Co-Mentor)}\\
            \tiny \textcolor{neonTeal}{\textbf{Department of CSE, Amrita School of Computing, Amrita Vishwa Vidyapeetham, Coimbatore}}
            \vspace{0.1cm}
        \end{block}
    \end{minipage}
\end{frame}
...
\begin{frame}{Uniqueness of the Innovation (Key Technical Novelties)}
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{1.} Multi-Head Temporal XAI}
                \scriptsize
                Embeds 4-head query-key temporal self-attentions providing explainable heatmap insights into exact sequence hours (e.g. SpO$_2$ drop at hour 14) driving risk alerts.
            \end{block}
            
            \begin{block}{\textcolor{neonTeal}{2.} CUSUM Concept Drift Auditing}
                \scriptsize
                An online Cumulative Sum (AD-CUSUM) neural monitor tracks validation loss residuals at each hospital site to flag patient demographic shifts in real-time.
            \end{block}
        \end{column}
        
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonAmber}{3.} Dynamic Dual-Phase (DDP) Attention}
                \scriptsize
                Integrates 2D cross-attention ($\alpha_t \otimes \beta_v$) to capture simultaneous sequence time steps AND multi-modal vital co-dependencies (e.g., HR vs Blood Pressure).
            \end{block}

            \begin{block}{\textcolor{neonRose}{4.} Client-Side Selective Personalization}
                \scriptsize
                Freezes the shared deep LSTM backbone upon drift alerts, fine-tuning only local classifier heads:
                \begin{itemize}
                    \item \textbf{38\% Bandwidth Savings} (1.52 GB vs 2.48 GB).
                    \item \textbf{Rapid Recalibration:} Adapts to hospital profiles in \textbf{6 minutes}.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}{Prototype Readiness \& Performance Metrics (TRL 4/5)}
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{Validated Experimental Performance}}
                \scriptsize
                Evaluated across multi-center PhysioNet ICU cohorts:
                \begin{itemize}
                    \item \textbf{86.51\% Test Accuracy:} Outperforms FedAvg (75.94\%) and FedProx (78.85\%) under non-IID data splits.
                    \item \textbf{0.8214 AUROC Score:} Strong discrimination for early sepsis crash prediction.
                    \item \textbf{38\% Bandwidth Reduction:} 1.52 GB network usage vs 2.48 GB in standard FL.
                \end{itemize}
            \end{block}
            
            \begin{block}{\textcolor{neonTeal}{Software \& Database Workstation}}
                \scriptsize
                Full-stack bedside workstation operational:
                \begin{itemize}
                    \item \textbf{FastAPI Backend \& SQLite Warehousing:} Decodes raw vitals using \texttt{scaler.pkl}.
                    \item \textbf{React Vite Bedside UI:} Features Doctor \& Admin portals.
                \end{itemize}
            \end{block}
        \end{column}
        
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonAmber}{Bedside Workstation Telemetry Interface}}
                \centering
                \includegraphics[width=\textwidth,height=0.48\textheight,keepaspectratio]{images/dashboarddoctor.png} \\
                \vspace{0.05cm}
                \tiny \textcolor{neonCyan}{\textbf{Bedside Doctor Portal:}} Real-time vital timelines, risk dials, and temporal attention saliency heatmaps.
            \end{block}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Competitive Matrix: Comparison of Key Capabilities}
    \begin{columns}[c]
        \begin{column}{0.72\textwidth}
            ...
            Local Customization (CSSP) & \textbf{\textcolor{neonTeal}{Yes}} & \textcolor{neonRose}{No} & \textcolor{neonRose}{No} & \textcolor{neonRose}{No} \\
            Edge-AI Deployment & \textbf{\textcolor{neonTeal}{Yes}} & \textcolor{neonAmber}{Partial} & \textbf{\textcolor{neonTeal}{Yes}} & \textcolor{neonRose}{No} \\
            DPDPA-Ready Compliance & \textbf{\textcolor{neonTeal}{Yes}} & \textcolor{neonAmber}{Partial} & \textcolor{neonAmber}{Partial} & \textcolor{neonAmber}{Partial} \\
            \hline
            \end{tabular}
            \vspace{0.2cm}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{Indian MSME Hardware Integration}}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Local Assembly Partner:} Discussions initiated with local embedded electronics and medical device MSMEs in Coimbatore for PCB assembly and edge hardware enclosure fabrication.
                \end{itemize}
            \end{block}
        \end{column}
...
\begin{frame}{Market Sizing \& Government Adoption}
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{TAM/SAM/SOM Sizing}}
                \scriptsize
                Detailed market mapping highlights scaling capacity:
                \begin{itemize}
                    \item \textbf{Estimated TAM: Rs. 1,000 Crores} (India's Clinical Decision Support System market)$^\dagger$.
                    \item \textbf{Estimated SAM: Rs. 375 Crores} (Corporate/private hospital ICU networks representing ~2,50,000 private ICU beds).
                    \item \textbf{Estimated SOM: Rs. 40 Crores} (Regional hospital networks targetable in Years 1--2 representing 12 chains).
                \end{itemize}
            \end{block}
            
            \begin{block}{\textcolor{neonTeal}{Government Adoption}}
                \scriptsize
                Designed for scalable deployment across public healthcare infrastructure:
                \begin{itemize}
                    \item \textbf{Potential Users:} AIIMS, State Medical Colleges, Government Hospitals, District Hospitals, Corporate Chains, Tele-ICU Networks.
                \end{itemize}
            \end{block}
        \end{column}
        
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonAmber}{Commercialization \& Scaling Strategy}}
                \scriptsize
                We scale through a 5-Phase commercialization strategy:
                \begin{enumerate}
                    \item \textbf{Phase 1:} Pilot hospital validation.
                    \item \textbf{Phase 2:} Regional network deployment.
                    \item \textbf{Phase 3:} Government procurement and public hospital deployment.
                    \item \textbf{Phase 4:} Scaling to private hospital networks.
                    \item \textbf{Phase 5:} Global export scaling.
                \end{enumerate}
            \end{block}
        \end{column}
    \end{columns}
...
\begin{frame}{Proposed Budget Justification (Total: \textbf{Rs. 15.0 Lakhs})}
    \begin{block}{Budget Request Under MSME Idea Hackathon 6.0 Guidelines (Maximum Grant):}
        \scriptsize
        We request Rs. 15 Lakhs to fund the transition of our working prototype into physical clinical pilot installations:
    \end{block}
    
    \begin{columns}[t]
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonCyan}{\textbf{1. Technology Costs}}}
                \centering
                \vspace{0.1cm}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item \textbf{Hardware \& Assembly (3.6L):} 3 Edge-AI Jetson nodes, PCB assembly, medical touch displays, workstation enclosures with Coimbatore MSMEs.
                    \item \textbf{Data Annotation (3.4L):} Expert clinician curation \& vital stream simulation.
                    \item \textbf{Security Audits (3.0L):} Penetration testing \& DPDPA audits.
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonTeal}{\textbf{2. Clinical Mentorship}}}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item ICU clinical validation guidance (1.8L).
                    \item Incubation facility \& testing lab support (1.2L).
                \end{itemize}
            \end{block}
        \end{column}
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonTeal}{[Impact]} High Social \& Medical Impact}
                ...
                \begin{itemize}
                    \item Improves patient clinical outcomes through early clinical fluid and antibiotic intervention.
                    \item Reduces ICU average length of stay (ALoS), helping to potentially reduce ICU treatment costs.
                \end{itemize}
            \end{block}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{[Alignment]} National Mission Alignment}
                \scriptsize
                \begin{itemize}
                    \item \textbf{Aatmanirbhar Bharat:} Completely local design, reducing dependency on imported clinical systems.
                    \item \textbf{Viksit Bharat @2047:} Empowers rural and semi-urban health centers with low-cost clinical intelligence.
                    \item \textbf{High Feasibility:} Functional prototype developed, compiled, and validated on actual public EHR cohorts.
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
