    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{A.} Multi-Head Temporal XAI}
                \scriptsize
                Standard models are black-boxes. We embed temporal self-attentions that provide explainable insights into which specific hours and vital trends (e.g. SpO$_2$ drop at hour 14) influenced the alert.
            \end{block}
    ...
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonCyan}{TRL 4/5 Readiness Status}}
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Public Health Ready:} Architected for scalable deployment and pilot validation within Indian public healthcare environments.
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{\textcolor{neonTeal}{Clinical Pilot Validation}}
                ...
                \begin{itemize}
                    \item \textbf{Clinical Collaboration:} Ongoing engagement with ICU specialists to refine predictive alert thresholds and clinical workflow.
    ...
    \begin{columns}[t]
        \begin{column}{0.31\textwidth}
            \begin{block}{\textcolor{neonCyan}{\textbf{1. Technology \& Ops}}}
                ...
                \flushleft\tiny
                \begin{itemize}
                    \item Prototyping component fabrication, edge hardware prototyping and validation, and embedded assembly (3.6L).
