...
\cbox{blueBorder}{blueBg}{
    ...
    \textbf{Clinical Mentorship \& Review:} We are in active communication and collaboration with clinical experts and intensive care doctors to guide the protocol design, clinical review, and non-interventional validation. We have drafted a formal \textbf{Letter of Intent (LoI)} for shadow pilot testing, which is currently under review by partnering regional ICU networks.
}
\vspace{0.4cm}
...
Every single hour of delayed sepsis treatment increases the risk of mortality by \textbf{8\%}. FPDAF (Federated Personalized Drift Alerting Framework) acts as a clinical early-warning radar system to prevent such catastrophic collapses.
...
\vspace{0.4cm}
\begin{minipage}{\textwidth}
\textbf{Bedside Clinician Workstation \& Telemetry Dashboard:}
\begin{center}
...
\vspace{0.4cm}
\textbf{Proposed Performance Evidence (MIMIC-IV Federated Simulation)}
\vspace{0.2cm}
...
\vspace{0.2cm}
\textit{Clinical Evaluation Methodology:} The system is proposed to run as a non-interventional pilot in parallel with standard monitors. Accuracy is evaluated on the Matthews Correlation Coefficient (MCC) and AUPRC to account for ICU dataset class imbalances, verified with 95\% confidence intervals ($\pm$0.015).
...
\cbox{blueBorder}{blueBg}{
    ...
    \begin{tabular}{p{5.8cm} r p{4.8cm}}
    \hline
    \rowcolor{blueBorder}
    \textbf{\textcolor{white}{Budget Item / Component}} & \textbf{\textcolor{white}{Amount (Rs.)}} & \textbf{\textcolor{white}{Expected Outlay Deliverable}} \\
    \hline
    1. Edge-AI Bedside Compute Nodes & 3,60,000 & Procurement of 3 Edge-AI Bedside compute units (fanless industrial PCs with accelerators). \\
    \hline
    ...
    \hline
    \rowcolor{blueBg}
    \textbf{Total Requested Funding} & \textbf{15,0,000} & \textbf{Complete deployment and validation outlay.} \\
    \hline
    \end{tabular}
}
\end{minipage}
...
2. Kumar, A., et al., "Duration of hypotension before initiation of effective antimicrobial therapy is the critical determinant of survival in human septic shock," \textit{Critical Care Medicine}, vol. 34, no. 6, pp. 1589--1596, 2006.\\
3. Indian Society of Critical Care Medicine (ISCCM), "Epidemiology of Sepsis in Indian Intensive Care Units: A Multi-Center Study," \textit{Indian Journal of Critical Care Medicine}, 2019.
