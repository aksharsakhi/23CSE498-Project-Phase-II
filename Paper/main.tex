...
\begin{itemize}
\item \textbf{Formulation of AD-CUSUM Algorithm}: We invent an Adaptive Divergence-Weighted CUSUM drift detection algorithm that integrates Jensen-Shannon prediction entropy divergence ($D_{\text{JSD}}$) and gradient variance weighting ($w_{\text{grad}}$) to detect institutional concept drift without mini-batch noise false alarms.
\item \textbf{Formulation of DDP-ERP Personalization Algorithm}: We design a Dynamic Dual-Phase Cross-Attention and Entropy-Regularized Soft-Personalization loss ($\mathcal{L}_{\text{DDP-ERP}}$), boosting personalized model accuracy to **96.42\%** and AUROC to **0.9418**.
\item \textbf{Client-Side Selective Personalization (CSSP)}: We implement a zero-upload local parameter freezing protocol upon drift alert, saving **38\% in communication bandwidth** (1.52 GB vs. 2.48 GB).
...
\subsection{Explainable AI (XAI) in Critical Care}
...
\subsection{PhysioNet 2019 Cohort Processing}
...
Figures~\ref{fig:preprocessing_comparison} and \ref{fig:preprocessing_padding} visually validate the preprocessing transformations and zero pre-padding routines.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/preprocessing_comparison.png}
\caption{Vital sign time-series before and after patient-level imputation and leakage-free z-score normalization.}
\label{fig:preprocessing_comparison}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/preprocessing_padding.png}
\caption{Zero pre-padding validation on a short-stay ICU patient window ($T < 24$h) to form uniform 24-hour sequence matrices.}
\label{fig:preprocessing_padding}
\end{figure}

\section{Centralized Baseline Architecture}
...
The centralized model early-stopped at Epoch 9 as validation AUROC peaked at 0.8232. Final test set metrics are detailed in Table~\ref{tab:metrics}. Figures~\ref{fig:baseline_roc} and \ref{fig:baseline_confusion} display the test ROC curve (AUROC = 0.8058) and confusion matrix heatmap.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\linewidth]{images/baseline_roc.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\linewidth]{images/baseline_confusion_matrix.png}
\caption{Centralized baseline test set confusion matrix heatmap.}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/federated_rounds_loss.png} &
\includegraphics[width=0.48\linewidth]{images/federated_rounds_auroc.png} \\
(a) Validation Loss & (b) Validation AUROC
\end{tabular}
\caption{FedAvg global model performance across communication rounds.}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/federated_comparative_roc.png} &
\includegraphics[width=0.48\linewidth]{images/federated_confusion_matrix.png} \\
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/fedprox_rounds_loss.png} &
\includegraphics[width=0.48\linewidth]{images/fedprox_rounds_auroc.png} \\
(a) Validation Loss & (b) Validation AUROC
\end{tabular}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/fedprox_three_way_roc.png} &
\includegraphics[width=0.48\linewidth]{images/fedprox_confusion_matrix.png} \\
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/four_way_roc_curve.png} &
\includegraphics[width=0.48\linewidth]{images/ditto_personalized_confusion_matrix.png} \\
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/cusum_drift_scores.png}
\caption{Client running AD-CUSUM concept drift scores and trigger points ($H=3.0$).}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\linewidth]{images/five_way_roc_curve.png} &
\includegraphics[width=0.48\linewidth]{images/temporal_attention_profile.png} \\
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth]{images/fpdaf_personalized_confusion_matrix.png}
