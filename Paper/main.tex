...
The centralized model early-stopped at Epoch 9 as validation AUROC peaked at 0.8232. Final test set metrics are detailed in Table~\ref{tab:metrics}. Figure~\ref{fig:baseline_results} presents the test ROC curve (AUROC = 0.8058) and confusion matrix heatmap.
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/baseline_roc.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/baseline_confusion_matrix.png}
\caption{(Left) Receiver Operating Characteristic (ROC) curve of the baseline model on the test dataset. (Right) Centralized baseline test set confusion matrix heatmap.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/federated_rounds_loss.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/federated_rounds_auroc.png}
\caption{FedAvg global model performance across 10 communication rounds: (Left) Validation Loss progression, (Right) Validation AUROC progression.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/federated_comparative_roc.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/federated_confusion_matrix.png}
\caption{(Left) Comparative test set ROC curve overlay for FedAvg vs Centralized baseline. (Right) FedAvg global model test confusion matrix heatmap.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/fedprox_rounds_loss.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/fedprox_rounds_auroc.png}
\caption{FedProx global model training metrics across rounds: (Left) Validation Loss curve, (Right) Validation AUROC curve.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/fedprox_three_way_roc.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/fedprox_confusion_matrix.png}
\caption{(Left) Three-way comparative test set ROC curve overlay. (Right) FedProx test set confusion matrix heatmap.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.48\textwidth]{images/four_way_roc_curve.png}
\hfill
\includegraphics[width=0.48\textwidth]{images/ditto_personalized_confusion_matrix.png}
\caption{(Left) Four-way comparative test set ROC curve overlay. (Right) Ditto personalized model test confusion matrix heatmap.}
